...
router.get("/:id/movies/genres/:query",(req,res)=>{
   console.log(req.params)
   let regexp = new RegExp("^"+ req.params.query,'i');
   Movie.find({category:mongoose.Types.ObjectId(req.params.id),genres:regexp})
   .populate('category')
...
// router.get("/:id/movies/genra/:genra",(req,res)=>{
//    console.log(req.params)
